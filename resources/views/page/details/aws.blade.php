    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <canvas id="areaHum" style="height:250px"></canvas>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <canvas id="areaPress" style="height:250px"></canvas>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <canvas id="areaWind" style="height:250px"></canvas>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <canvas id="areaRain" style="height:250px"></canvas>
            </div>
        </div>
    </div>
